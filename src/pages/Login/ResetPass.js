...
const ResetPass = () => {
    ...
    return (
        <div className='m-20'>
            <h2 className='text-green-600 font-bold text-4xl text-center'>Reset Password</h2>
            <form onSubmit={handleSubmit} className="w-4/5 md:w-1/2 mx-auto">
                ...
                <div className='mt-5'>
                    <input type="submit" value="Submit" className="block w-full px-3 py-1.5 text-base font-normal  bg-green-600 text-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out hover:bg-green-500 hover:text-white hover:border-green-600 m-0 cursor-pointer" />
                </div>
            </form>
            <ToastContainer />
        </div>
